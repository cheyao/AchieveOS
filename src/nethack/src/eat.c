...
STATIC_OVL NEARDATA
const char comestibles[] = {FOOD_CLASS, 0};
STATIC_OVL NEARDATA
const char offerfodder[] = {FOOD_CLASS, AMULET_CLASS,
                            0};
            ...
            if (otmp->otyp == SLIME_MOLD && !otmp->cursed
                ...
                pline("My, this is a %s %s!",
                      ...
                      singular(otmp, xname));
                       ...
                       !Sleep_resistance) { ; /* skip core joke; feedback deferred til fpostfx() */
        ...
        int old, inc, typ;
{
    ...
    if (absinc == 0 || sgnold != sgninc || absold + absinc < 10) { ; /* use inc as-is */
