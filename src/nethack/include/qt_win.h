...
class NetHackQtStringRequestor
: QDialog
{
private:
QLabel prompt;
...
public:
NetHackQtStringRequestor(NetHackQtKeyBuffer
&,
const char *p,
...
class NetHackQtExtCmdRequestor
:
public QDialog
        {
                Q_OBJECT
...
class NetHackQtMenuOrTextWindow
:
public NetHackQtWindow
        {
                private:
...
public:
NetHackQtYnDialog(NetHackQtKeyBuffer
&keysource, const char *,
const char *, char);
