...
E void FDECL(init_random,(int FDECL((

*fn), (int))));

E void FDECL(reseed_random,(int FDECL((
...
E void VDECL(custompline,(unsigned, const char *, ...)
...
E void VDECL(You_feel,(const char *, ...)

) PRINTF_F(1, 2);

E void VDECL(You_cant,(const char *, ...)

) PRINTF_F(1, 2);

E void VDECL(You_hear,(const char *, ...)

) PRINTF_F(1, 2);

E void VDECL(You_see,(const char *, ...)

) PRINTF_F(1, 2);

E void VDECL(pline_The,(const char *, ...)

) PRINTF_F(1, 2);

E void VDECL(There,(const char *, ...)

) PRINTF_F(1, 2);

E void VDECL(verbalize,(const char *, ...)

) PRINTF_F(1, 2);

E void VDECL(raw_printf,(const char *, ...)
...
E void VDECL(config_error_add,(const char *, ...)
...
E char *FDECL(get_rnd_text,(const char *, char *, int FDECL((
...
E void FDECL(set_selection_floodfillchk,(int FDECL((
