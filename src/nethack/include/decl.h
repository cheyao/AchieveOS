...
E NEARDATA dest_area
updest,
dndest; /* level-change destination areas */
...
E NEARDATA const anything
zeroany;   /* init'd and defined in decl.c */
...
/* Vision */
E NEARDATA boolean
vision_full_recalc; /* TRUE if need vision recalc */
