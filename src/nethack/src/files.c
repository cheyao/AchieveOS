...
STATIC_DCL boolean
FDECL(is_config_section,
(const char *));
STATIC_DCL boolean
FDECL(handle_config_section,
(char *));
#ifdef SELF_RECOVER
...
{
    return !((boolean)
    parse_sym_line(buf, symset_which_set));
}
